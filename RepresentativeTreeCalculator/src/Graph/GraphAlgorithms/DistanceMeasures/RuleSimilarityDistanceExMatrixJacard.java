...
public class RuleSimilarityDistanceExMatrixJacard extends TreeDistanceMeasure<DecisionTreeNode, DecisionTreeEdge> {
    @Expose
    String name = "RuleSimilarityDistanceExMatrixJacard";
    private final List<List<Double>> data = new ArrayList<>();
    private final int SCALE_FACTOR = 100;

    public RuleSimilarityDistanceExMatrixJacard(String inputFileLocation) throws IOException {
