function createMainPanel() {
    ...
    createOverviewContent(tab1Content);
    ...
    window.addEventListener('mousedown', function(e) {
        ...
        if (e.target.classList.contains("handler")) {
            ...
            if (e.target.id === "tab1Handler") {
                draggingTabContent = "#tab1Content"
    ...
    document.addEventListener('mouseup', function() {
        ...
        if (isHandlerDragging && draggingTabContent === "#tab1Content") {
            updatePositions();
        }
...
function createOverviewContent(tab1Content) {
    let tabContent = tab1Content.append("div").style("display", "flex").style("height", "100%");

    let firstPanel = tabContent.append("div").attr("class", "box").attr("id", "firstPanel").style("width", "800px");
    ...
    secondTab2.append("a").attr("data-toggle", "pill").attr("href", "#tab12Content").text("test12");
    ...
    let tab12Content = contentDiv.append("div")
        ...
        .attr("class", "tab-pane fade").text("test12");
}
